...
public class GreenArrowLeft : IProjectile
{
    // Properties
    ...
    public GreenArrowLeft(Texture2D Texture, Vector2 Position, int velocity, float Scale, bool Friendly = false)
    {
        this.Texture = Texture;
        this.scale = Scale;
        this.SourceRect = ProjectileAnimations.GreenArrowLeft;
