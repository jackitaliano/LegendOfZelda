...
public class GreenArrowRight : IProjectile
{
    // Properties
    ...
    public GreenArrowRight(Texture2D Texture, Vector2 Position, int velocity, float Scale, bool Friendly = false)
    {
        this.Texture = Texture;
        this.Position = Position;
        this.scale = Scale;
        this.SourceRect = ProjectileAnimations.GreenArrowRight;
