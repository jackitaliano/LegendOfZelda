...
public class GreenArrowUp : IProjectile
{
    // Properties
    ...
    public GreenArrowUp(Texture2D Texture, Vector2 Position, int velocity, float Scale, bool Friendly = false)
    {
        this.Texture = Texture;
        this.scale = Scale;
        this.SourceRect = ProjectileAnimations.GreenArrowUp;
